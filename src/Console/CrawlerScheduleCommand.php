...
namespace Nguonc\Crawler\NguoncCrawler\Console;
...
class CrawlerScheduleCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'nguonc:plugins:nguonc-crawler:schedule';
    ...
    {
        $this->logger = Log::channel('nguonc-crawler');
        parent::__construct();
    }
    ...
    public function handle()
    {
        ...
        $link = sprintf('%s/api/films/phim-moi-cap-nhat', Option::get('domain'));
        $data = collect();
